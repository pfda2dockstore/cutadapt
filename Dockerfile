# Generated by precisionFDA exporter (v1.0.3) on 2018-06-14 16:47:32 +0000
# The asset download links in this file are valid only for 24h.

# Exported app: cutadapt, revision: 33, authored by: quan.wan.2
# https://precision.fda.gov/apps/app-F08pfFj0F6P8B80B4kPK1Vk8
...
RUN ["/bin/bash","-c","echo -E \\{\\\"spec\\\":\\{\\\"input_spec\\\":\\[\\{\\\"name\\\":\\\"input\\\",\\\"class\\\":\\\"file\\\",\\\"optional\\\":false,\\\"label\\\":\\\"Reads\\ File\\\",\\\"help\\\":\\\"\\\"\\},\\{\\\"name\\\":\\\"adapter\\\",\\\"class\\\":\\\"string\\\",\\\"optional\\\":false,\\\"label\\\":\\\"Adapter\\ Sequence\\\",\\\"help\\\":\\\"\\\"\\}\\],\\\"output_spec\\\":\\[\\{\\\"name\\\":\\\"output\\\",\\\"class\\\":\\\"file\\\",\\\"optional\\\":false,\\\"label\\\":\\\"Trimmed\\ Reads\\ File\\\",\\\"help\\\":\\\"\\\"\\}\\],\\\"internet_access\\\":true,\\\"instance_type\\\":\\\"baseline-8\\\"\\},\\\"assets\\\":\\[\\],\\\"packages\\\":\\[\\]\\} \u003e /spec.json"]
RUN ["/bin/bash","-c","echo -E \\{\\\"code\\\":\\\"pip\\ install\\ --user\\ --upgrade\\ cutadapt\\\\ncd\\ /\\\\n\\#\\#name\\ \\=\\ \\\\\\\"output_file.\\$\\{input_path\\#\\#\\*.\\}\\\\\\\"\\\\n\\~/.local/bin/cutadapt\\ -a\\ \\$adapter\\ \\$input_path\\ \\\\u003e\\ output_file.\\$\\{input_path\\#\\#\\*.\\}\\\\nemit\\ output\\ output_file.\\$\\{input_path\\#\\#\\*.\\}\\\"\\} | python -c 'import sys,json; print json.load(sys.stdin)[\"code\"]' \u003e /script.sh"]
